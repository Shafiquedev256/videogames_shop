...
export const Footer = () => {
  return (
    <>
      <footer className='w-full font-body bg-gray-900'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8'>
            <div className='col-span-full mb-10 lg:col-span-2 lg:mb-0'>
              <Link
                to='/'
                className='flex justify-center lg:justify-start text-purple-600 font-title text-bold text-2xl'
              >
                S.M Games.
              </Link>
              ...
              <Link
                to='/'
                className='py-2.5 px-5 h-9 block w-fit bg-purple-600 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-indigo-700 lg:mx-0'
              >
                Contact us
              </Link>
            </div>
          ...
          <div className='py-7 border-t border-gray-200'>
            <div className='flex items-center justify-center flex-col lg:justify-between lg:flex-row'>
              <span className='text-sm text-gray-400 '>
                ©<Link to='/'>S.M Games </Link> 2024, All rights reserved.
              </span>
              <div className='flex mt-4 space-x-4 sm:justify-center lg:mt-0 '>
                <Link
                  to='/'
                  className='w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-300'
                >
                  <svg
